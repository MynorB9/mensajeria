  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Proporcione los datos para su orden</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
				<div class="container">
          <p class="caption">Proporcione sus datos de direccion y pago.</p>
...
<div>
                    ...
                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order.php" novalidate="novalidate">
                      <div class="row">
                        <div class="input-field col s12">
							<label for="payment_type">Forma de pago</label><br><br>
							<select id="payment_type" name="payment_type">
									<option value="Wallet" selected>Tarjeta Credito/Debito</option>
									<option value="Cash On Delivery" <?php if(!$verified) echo 'disabled';?>>Paga al recibir</option>
							</select>
                        </div>
                      </div>					
                      <div class="row">
                      ...
                      <div class="row">
                        <div class="row">
                          <div class="input-field col s12">
                            <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Confirmar
        ...
        <div class="container">
          <p class="caption">Tiempo de recibido</p>
          <div class="divider"></div>
          <!--editableTable-->
...
<?php
    ...
    echo '<li class="collection-item">
        <div class="row">
            ...
            <div class="col s3">
                <span><strong>Q. '.$total.'</strong></span>
            </div>
        </div>
    </li>';
