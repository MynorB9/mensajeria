    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Orden de Servicio</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Ordenes</a>
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Historial de Ordenes</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Historial de los servicios solicitados</p>
                ...
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						echo '<li class="collection-item avatar">
                              ...
                              <span class="collection-header">No. Orden: '.$row['id'].'</span>
                              <p><strong>Fecha:</strong> '.$row['date'].'</p>
                              <p><strong>Forma de Pago:</strong> '.$row['payment_type'].'</p>
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
                            ...
                            <div class="col s2">
                            <span>'.$row1['quantity'].' Cantidad</span>
                            </div>
                            <div class="col s3">
                            <span>Q. '.$row1['price'].'</span>
                            </div>
                            </div>
                            </li>';
							$id = $row1['order_id'];
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s3">
                                                <span><strong>Q. '.$row['total'].'</strong></span>
                                            </div>';
								...
								echo '<form action="routers/cancel-order.php" method="post">
										...
										<button class="btn waves-effect waves-light right submit" type="submit" name="action">Pagar Orden
