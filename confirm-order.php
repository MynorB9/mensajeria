    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Orden de Servicios</a>
            </li>
                <li class="no-padding">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Informacion de la Orden</h5>
              </div>
            </div>
          </div>
        </div>
...
<?php
    echo '<li class="collection-item avatar">
		...
		<p><strong>Numero de Contacto:</strong> '.$contact.'</p>
		<p><strong>Direccion:</strong> '.htmlspecialchars($_POST['address']).'</p>	
		<p><strong>Forma de Pago:</strong> '.$_POST['payment_type'].'</p>			
...
<button class="btn cyan waves-effect waves-light right" type="submit" name="action" <?php if($_POST['payment_type'] == 'Wallet') {if ($balance-$total < 0) {echo 'disabled'; }}?>>Confirmar Orden
